    ...
    mapper(0)
{
    ...
    ui->aychAtStartup->setToolTip(ui->aychAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->aychAtStartup->setText(ui->aychAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openAychConfButton->setToolTip(ui->openAychConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new AychUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->aychAtStartup, OptionsModel::StartAtStartup);
