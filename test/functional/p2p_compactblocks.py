...
# TestP2PConn: A peer we use to send messages to aychd, and store responses.
...
class CompactBlocksTest(AychTestFramework):
    ...
    # This test actually causes aychd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that aychd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for aychd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # aychd will not send blocktxn responses for blocks whose height is
