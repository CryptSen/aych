...
"""Verify that starting aych with -h works as expected."""

from test_framework.test_framework import AychTestFramework
from test_framework.util import assert_equal

class HelpTest(AychTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aych with -h for help text")
        ...
        self.log.info("Start aych with -version for version information")
        ...
        self.log.info("Start aychd with -fakearg to make sure it does not start")
